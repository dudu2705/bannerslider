 ...
 */
class ExportXml extends \DAT\Bannerslider\Controller\Adminhtml\Banner
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('DAT\Bannerslider\Block\Adminhtml\Banner\Grid')->getXml();
