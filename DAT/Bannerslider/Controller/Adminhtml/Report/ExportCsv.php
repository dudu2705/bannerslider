 ...
 */
class ExportCsv extends \DAT\Bannerslider\Controller\Adminhtml\Report
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('DAT\Bannerslider\Block\Adminhtml\Report\Grid')->getCsv();
