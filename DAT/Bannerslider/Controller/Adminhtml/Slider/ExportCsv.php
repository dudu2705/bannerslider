 ...
 */
class ExportCsv extends \DAT\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('DAT\Bannerslider\Block\Adminhtml\Slider\Grid')->getCsv();
