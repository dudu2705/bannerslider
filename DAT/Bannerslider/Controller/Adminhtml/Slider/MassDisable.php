 ...
 */
class MassDisable extends \DAT\Bannerslider\Controller\Adminhtml\AbstractAction
{
    ...
    {
        $sliderCollection = $this->_objectManager->create('DAT\Bannerslider\Model\ResourceModel\Slider\Collection');
