...
class Bannerslider extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'DAT_Bannerslider::bannerslider.phtml';
    ...
    public function __construct(
        ...
        \DAT\Bannerslider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
        array $data = []
    ) {
     ...
     *
     * @param \DAT\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection [description]
     *
     * @return \DAT\Bannerslider\Block\Bannerslider [description]
     */
    public function appendChildBlockSliders(
        \DAT\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection
    ) {
        foreach ($sliderCollection as $slider) {
            $this->append(
                $this->getLayout()->createBlock(
                    'DAT\Bannerslider\Block\SliderItem'
