...
namespace DAT\Bannerslider\Block\Adminhtml\Slider\Edit\Tab;
...
class Banners extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \DAT\Bannerslider\Model\ResourceModel\Banner\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer' => 'DAT\Bannerslider\Block\Adminhtml\Banner\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'title',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'DAT\Bannerslider\Block\Adminhtml\Slider\Edit\Tab\Helper\Renderer\EditBanner',
            ]
        );
