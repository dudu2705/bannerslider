 ...
 */
namespace DAT\Bannerslider\Block\Adminhtml\Report;
use DAT\Bannerslider\Model\ResourceModel\Report\Collection as ReportCollection;
/**
 * Report grid.
 * @category DAT
 * @package  DAT_Bannerslider
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \DAT\Bannerslider\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'DAT\Bannerslider\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
